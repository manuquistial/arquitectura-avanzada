...
class Settings(BaseSettings):
    ...
    servicebus_connection_string: str = Field(default="", alias="SERVICEBUS_CONNECTION_STRING", description="Service Bus connection string")
    ...
    redis_password: str = Field(default="", alias="REDIS_PASSWORD", description="Redis password")
    ...
    app_insights_connection_string: str = Field(default="", alias="APPLICATIONINSIGHTS_CONNECTION_STRING", description="Application Insights connection string")
